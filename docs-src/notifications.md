...
| `ADMIN_CARGA_TRANSITION_REQUEST` | Email | 📋 Nueva solicitud de segunda carga | Se genera cuando un vendedor solicita habilitación para publicar en una segunda carga del mismo transporte. Incluye el ID del vendedor, el tipo de carga y la carga actual de origen. |
