const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/sizeCapture-X5ZJPWSS.DeG9Y22c.js","assets/app.CQ2Www5d.js","assets/chunks/framework.UkvNxxWY.js","assets/chunks/theme.CZhWekeJ.js"])))=>i.map(i=>d[i]);
import { a2 as __vitePreload } from "./framework.UkvNxxWY.js";
import { c as clear$2 } from "./chunk-RYQCIY6F.BO_xwF0T.js";
import { am as markers_default, an as clear2, ao as clear, ap as clear$1, l as log, c as getConfig2, ag as insertNode, af as insertCluster, ah as positionNode, at as insertEdge, av as insertEdgeLabel, y as getConfig, as as getSubGraphTitleMargins, aw as edgeLabels, x as utils_default, ax as terminalLabels, _ as __name, ay as markerOffsets } from "../app.CQ2Www5d.js";
...
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await __vitePreload(async () => {
      const { captureNodeSizes: captureNodeSizes2 } = await import("./sizeCapture-X5ZJPWSS.DeG9Y22c.js");
