...
export type AssignGroupTotalWeightRequest = {
  order_ids: (number)[]
  total_weight_kg: number
}

export type AssignGroupTotalWeightResponse = {
  delivery: {
    [key: string]: unknown
  }
  message: string
...
export interface Operations {
  ...
  "backend_put_api_v1_bodeguero_pedidos_peso_total_grupo": {
    method: "PUT"
    path: "/api/v1/bodeguero/pedidos/peso-total-grupo"
    requestBody: AssignGroupTotalWeightRequest
    responses: {
      "200": AssignGroupTotalWeightResponse
      "400": ErrorResponse
      "401": ErrorResponse
      "403": ErrorResponse
      "404": ErrorResponse
